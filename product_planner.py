...
def _semantic_product_conflict(
    ...
    bare_compound_guards = (
        ...
        (r"^(?:hvitløk|garlic|vitlök)$", r"(?:\b(?:hvitløk|garlic|vitlök)s?\s*[,/-]?\s*(?:pulver|powder|paste|puré|puree|saus|sauce|brød|bread|[a-zæøåöä]*presset|pressed|knust|crushed|hakket|minced|aioli|dressing|olje|oil)\b|\b(?:[a-zæøåöä]*presset|pressed|knust|crushed|hakket|minced)\s+(?:hvitløk|garlic|vitlök)\b)"),
